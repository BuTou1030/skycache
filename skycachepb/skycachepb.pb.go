...
func init() {
	proto.RegisterType((*Request)(nil), "skycachepb.Request")
	proto.RegisterType((*Response)(nil), "skycachepb.Response")
}

func init() { proto.RegisterFile("skycachepb.proto", fileDescriptor_889d0a4ad37a0d42) }
